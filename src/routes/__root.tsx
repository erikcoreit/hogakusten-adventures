...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Höga Kusten Micro Adventures" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "Höga Kusten Micro Adventures",
          url: "https://hogakusten-adventures.lovable.app",
          inLanguage: "sv-SE",
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: "Höga Kusten Micro Adventures",
          url: "https://hogakusten-adventures.lovable.app",
          logo: "https://hogakusten-adventures.lovable.app/favicon.png",
        }),
      },
    ],
  }),
